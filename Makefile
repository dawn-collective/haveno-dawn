...
seednode-local:
	./haveno-seednode$(APP_EXT) \
		...
		--nodePort=2002 \
		--appName=haveno-dawn-XMR_LOCAL_Seed_2002 \
...
seednode2-local:
	./haveno-seednode$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=2003 \
		--appName=haveno-dawn-XMR_LOCAL_Seed_2003 \
		--xmrNode=http://localhost:28081 \
...
arbitrator-daemon-local:
	...
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=4444 \
		--appName=haveno-dawn-XMR_LOCAL_arbitrator \
		--apiPassword=apitest \
		--apiPort=9998 \
...
arbitrator2-daemon-local:
	...
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=7777 \
		--appName=haveno-dawn-XMR_LOCAL_arbitrator2 \
		--apiPassword=apitest \
		--apiPort=10001 \
		--useNativeXmrWallet=false \
...
user1-daemon-local:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=5555 \
		--appName=haveno-dawn-XMR_LOCAL_user1 \
		--apiPassword=apitest \
		--apiPort=9999 \
...
user2-desktop-local:
	./haveno-desktop$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=6666 \
		--appName=haveno-dawn-XMR_LOCAL_user2 \
		--apiPassword=apitest \
		--apiPort=10000 \
...
user3-desktop-local:
	./haveno-desktop$(APP_EXT) \
		...
		--useDevPrivilegeKeys=true \
		--nodePort=7778 \
		--appName=haveno-dawn-XMR_LOCAL_user3 \
		--apiPassword=apitest \
		--apiPort=10002 \
...
seednode-stagenet:
	./haveno-seednode$(APP_EXT) \
		...
		--nodePort=3002 \
		--appName=haveno-dawn-XMR_STAGENET_Seed_3002 \
...
seednode2-stagenet:
	./haveno-seednode$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=3003 \
		--appName=haveno-dawn-XMR_STAGENET_Seed_3003 \
		--xmrNode=http://127.0.0.1:38081 \
...
arbitrator-daemon-stagenet:
	...
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_STAGENET_arbitrator \
		--apiPassword=apitest \
		--apiPort=3200 \
		--passwordRequired=false \
		--xmrNode=http://127.0.0.1:38081 \
...
user1-daemon-stagenet:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_STAGENET_user1 \
		--apiPassword=apitest \
		--apiPort=3201 \
		--passwordRequired=false \
		--useNativeXmrWallet=false \
...
user2-daemon-stagenet:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_STAGENET_user2 \
		--apiPassword=apitest \
		--apiPort=3202 \
		--passwordRequired=false \
		--useNativeXmrWallet=false \
...
user3-desktop-stagenet:
	./haveno-desktop$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_STAGENET_user3 \
		--apiPassword=apitest \
		--apiPort=3203 \
		--useNativeXmrWallet=false \
...
seednode:
	./haveno-seednode$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=1002 \
		--appName=haveno-dawn-XMR_MAINNET_Seed_1002 \
...
seednode2:
	./haveno-seednode$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=1003 \
		--appName=haveno-dawn-XMR_MAINNET_Seed_1003 \
		--xmrNode=http://127.0.0.1:18081 \
...
arbitrator-daemon-mainnet:
	...
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_MAINNET_arbitrator \
		--apiPassword=apitest \
		--apiPort=1200 \
		--passwordRequired=false \
		--xmrNode=http://127.0.0.1:18081 \
...
arbitrator2-daemon-mainnet:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_MAINNET_arbitrator2 \
		--apiPassword=apitest \
		--apiPort=1205 \
		--passwordRequired=false \
		--xmrNode=http://127.0.0.1:18081 \
...
user1-daemon-mainnet:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_MAINNET_user1 \
		--apiPassword=apitest \
		--apiPort=1202 \
		--passwordRequired=false \
		--useNativeXmrWallet=false \
...
user2-daemon-mainnet:
	./haveno-daemon$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_MAINNET_user2 \
		--apiPassword=apitest \
		--apiPort=1203 \
		--passwordRequired=false \
		--useNativeXmrWallet=false \
...
user3-desktop-mainnet:
	./haveno-desktop$(APP_EXT) \
		...
		--useDevPrivilegeKeys=false \
		--nodePort=9999 \
		--appName=haveno-dawn-XMR_MAINNET_user3 \
		--apiPassword=apitest \
		--apiPort=1204 \
		--useNativeXmrWallet=false \
		--ignoreLocalXmrNode=false \
